    ...
    <div className="dark flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-primary to-cyan-glow px-5 py-2.5 text-sm font-semibold text-primary-foreground transition-transform hover:scale-105"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Matachakra" },
      { name: "description", content: "Your civic AI co-pilot — built for every voter." },
      { name: "author", content: "Matachakra" },
    ],
    links: [
...
function RootShell({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className="dark">
      ...
      <body>
        {/* WCAG 2.4.1 — Skip navigation for keyboard/screen-reader users */}
        <a
          href="#main-content"
